...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <button class="search-form-btn navbar-toggle btn btn-info" data-toggle="collapse" data-target="#navbar-search-form">
        ...
        <div class="container-fluid">
            ...
            <ul id="collapse" class="nav navbar-nav collapse navbar-collapse">
                ...
                <li><a id="course" href="course.jsp"><span class="glyphicon glyphicon-tasks"></span>&nbsp;&nbsp;课程</a></li>
                <li><a id="institution" href="institution.jsp"><span class="glyphicon glyphicon-fire"></span>&nbsp;&nbsp;机构</a></li>
                <%--<li><a href="#"><span></span>&nbsp;&nbsp;选项</a></li>--%>
                <%--<li><a href="#"><span></span>&nbsp;&nbsp;选项</a></li>--%>
                <li><a id="about" href="about.jsp"><span class="glyphicon glyphicon-info-sign"></span>&nbsp;&nbsp;关于</a></li>
            </ul>
